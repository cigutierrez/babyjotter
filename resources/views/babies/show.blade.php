...
<div class="row justify-content-center mt-5">
    <div class="col-md-6">
        <a href="/babies" class="btn btn-light btn-block textPrimary">Back to Babies</a>
    </div>
    <div class="col-md-6">
        <a href="/babies/{{ $baby->id }}/edit" class="btn btn-light btn-block textPrimary">Edit Baby Details </a>
    </div>
</div>
